"""
Qwen Multi-Image Edit — astronaut outfit (adapted from test_tutorial.py)
========================================================================
Same workflow as test_tutorial.py but adapted for:
  - girl.JPG (large 6000x4000 child photo)
  - одежда астронавта.png (astronaut costume reference)
  + ImageScaleToTotalPixels (0.5MP) to handle large input
  + Portrait resolution 832x1248

Usage:
  python3 test_tutorial_test.py
"""
import json
...
# --- Images ---
IMAGE1 = "girl.JPG"                   # Child photo (large 6000x4000)
...
prompt = {
    ...
    "51": {
        ...
        "inputs": {
            "images": ["50", 0],
            "filename_prefix": "tutorial_astronaut"
        }
    }
}
...
print(f"Submitting tutorial workflow (adapted for test/)...")
